...
import org.Hausarbeit.services.util.SafeString;
...
public class JDBCConnection {
    ...
    private String login = "jbrzez2s";
    private String passwort = "jbrzez2s";
    private String url = "jdbc:postgresql://dumbo.inf.h-brs.de/jbrzez2s";
